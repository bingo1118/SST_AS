...
public class Constants {
	public static final String REGISTER_USER_URL = "http://119.29.155.148/NotificationToPush/register.action";
	public static final String MODIFYLOGIN_PWD_URL = "http://119.29.155.148/NotificationToPush/modifyLoginPassword.action";
	public static final String ACCOUNT_INFO_URL = "http://119.29.155.148/NotificationToPush/setAccountInfo.action";
	...
	public static class MsgSection{
		...
		public static int MESG_SET_SYSTEM_MESSAGE_INDEX=55000;
		public static int CONTROL_CAMERA=56000;
		public static int MESG_SET_RECEIVE_DOOBELL=57000;
		public static int MESG_GET_LANGUEGE=58000;
	...
	public static class ZOOM{
		public static final byte ZOOM_BIG=0x5;
		public static final byte ZOOM_SMALL=0x15;
	}
