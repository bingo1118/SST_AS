...
//	private static final String SERVER1 = "http://192.168.1.222/";
//	private static final String SERVER2 = "http://192.168.1.222/";
//	private static final String SERVER3 = "http://192.168.1.222/";
//	private static final String SERVER4 = "http://192.168.1.222/";
...
//	private static final String SERVER2 = "http://c-telphone.com/";
	...
	public String doPost(List<NameValuePair> params, String url)
		...
		try {
			...
			if ((http_code = httpResp.getStatusLine().getStatusCode()) == 200) {
				...
				Log.e("my", "HttpPost鏂瑰紡璇锋眰澶辫触:" + http_code);
			...
			if (reconnect_count <= 3) {
				...
				Log.e("my", "鏇存崲鏈嶅姟鍣�" + CURRENT_SERVER);
				result = "{\"error_code\":998}";
			} else {
				randomServer();
				reconnect_count = 0;
	...
	public JSONObject modifyLoginPassword(String contactId, String sessionId,
		...
		try {
			jObject = new JSONObject(doPost(params, Constants.MODIFYLOGIN_PWD_URL));
			Log.e("my", jObject.toString());
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	/*
	 * flag 0锛氱粦瀹氭墜鏈哄拰閭锛�锛氱粦瀹氭墜鏈猴紝2锛氱粦瀹氶偖绠�
	 */
	public int setAccountInfo(String contactId, String phone, String email,
		...
		try {
			JSONObject jObject = new JSONObject(
					doPost(params, Constants.ACCOUNT_INFO_URL));
			Log.e("my", jObject.toString());
	...
	public JSONObject register(String VersionFlag, String Email, String CountryCode,
		...
		try {
			...
			String obj = doPost(params, Constants.REGISTER_USER_URL);
